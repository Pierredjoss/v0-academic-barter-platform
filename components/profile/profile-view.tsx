        ...
        <div className="relative px-4 pb-6 sm:px-6">
         ...
         {/* Info */}
          <div className="mt-8 sm:mt-4">
            {/* Si le nom est nul, on affiche l'email ou un pseudo par défaut */}
            <h1 className="text-2xl font-bold">
              {profile?.full_name || profile?.email?.split('@')[0] || "Utilisateur"}
            </h1>
            
            <div className="mt-2 flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
              {/* On affiche l'université SEULEMENT si elle existe en base, sinon on met un message d'aide */}
              {profile?.university ? (
                ...
                <span className="flex items-center gap-1 text-amber-600/80 italic">
                  <GraduationCap className="h-4 w-4" />
